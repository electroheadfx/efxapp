...
return array(
	...
	'bootstrap3'                   => array(
		...
		'first'                   => "\n\t\t<li>{link}</li>",
		'first-marker'            => "<span class='fa fa-step-backward'></span>",
		...
		'previous'                => "\n\t\t<li>{link}</li>",
		'previous-marker'         => "<span class='fa fa-chevron-left'></span>",
		...
		'next'                    => "\n\t\t<li>{link}</li>",
		'next-marker'             => "<span class='fa fa-chevron-right'></span>",
		...
		'last'                    => "\n\t\t<li>{link}</li>",
		'last-marker'             => "<span class='fa fa-step-forward'></span>",
